# Modified Case33 bus network

"""Power flow data for 33 bus, modified.
"""
...
def case33bw_mod():
    ...
    ppc['bus'][:, 2:4] = ppc['bus'][:, 2:4]/1000.  # Convert loads from kW to MW
    ...
    Vbase = ppc['bus'][0, 9]*1000.
    Sbase = ppc["baseMVA"] * (10**6)  # in VA
    ppc['branch'][:, 2:4] = ppc['branch'][:, 2:4]/(Vbase**2/Sbase)
